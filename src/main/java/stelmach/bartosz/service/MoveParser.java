...
public class MoveParser {
	...
	public Move parseMove(String move, boolean isWhite) {
		...
		boolean isMoveTaking = isPawnMove ? moveNotationValidator.isPawnMoveTaking(move)
				: moveNotationValidator.isMoveTaking(move);
	...
	public String getEndSquare(String move, boolean isPawnMove, boolean isMoveAmbiguous, boolean isMoveTaking,
